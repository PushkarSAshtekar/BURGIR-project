  ...
  return (
    <div className="w-full max-w-sm p-6 m-auto mx-auto rounded-lg shadow-md">
      ...
      <div className="flex flex-col items-center justify-center mx-auto">
        <p className="mb-4 font-semibold text-xl">BURGIR</p>
    ...
    <form className="mt-6">
        ...
        <div className="mt-4">
            ...
            <input type="password" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-lg focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
        </div>
    ...
    <div className="flex items-center justify-between mt-4">
        ...
        <a href="#" className="text-xs text-center text-black-500 uppercase hover:underline">
    ...
    <p className="mt-8 text-xs font-light text-center text-black-400"> Don't have an account? <a href="#" class="font-medium text-gray-700 hover:underline">Create One</a></p>
</div>
